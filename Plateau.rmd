...
## Brewer M.J., O'Hara R.B., Anderson B.J. & Ohlemüller R. (). Climate envelopes for species distribution models. Methods in Ecology and Evolution [Hopefully].

This code will reproduce the examples and figures from the paper, and hopefully help in understanding the related R package "plateau", also available on GitHub, as the following code suggests:
